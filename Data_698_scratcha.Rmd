...
```{r break up set,fig.showtext = TRUE,echo=FALSE,fig.width=13,warning=FALSE}
remainder_set<-read.csv('C:/Users/dawig/Desktop/Data698/Maryland/by_violation_category/remainder_set.csv')

remainder_set %>% 
  filter(str_detect(coll(remainder_set[,5]),'ACCIDENT'))->need_to_add_scene_of_accident_set
remainder_set %>% 
  filter(!(str_detect(coll(remainder_set[,5]),'ACCIDENT')))->remainder_set.csv


write.csv(need_to_add_scene_of_accident_set,'C:/Users/dawig/Desktop/Data698/Maryland/by_violation_category/need_to_add_scene_of_accident_b.csv',row.names=FALSE)
write.csv(stop_set,'C:/Users/dawig/Desktop/Data698/Maryland/by_violation_category/stopping_violations.csv',row.names=FALSE)
#write.csv(remainder_set,'C:/Users/dawig/Desktop/Data698/Maryland/by_violation_category/remainder_set.csv',row.names=FALSE)
```


```{r insurance_b,fig.showtext = TRUE,echo=FALSE,fig.width=13,warning=FALSE}
...
```{r write violation files,fig.showtext = TRUE,eval=FALSE,fig.width=13}
```

```{r insurance,fig.showtext = TRUE,eval=FALSE,fig.width=13}
violations<-read.csv('C:/Users/dawig/Desktop/Data698/Maryland/Traffic_Violations.csv')
